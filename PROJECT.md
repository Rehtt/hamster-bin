...
│       ├── pages/             # 主要业务页面
│       ├── types/             # 前端共享类型
│       ├── utils/             # 前端工具函数（price.ts 金额换算/格式化，stockLog.ts 流水展示）
│       └── assets/            # 前端源码内资源
└── web_legacy/
